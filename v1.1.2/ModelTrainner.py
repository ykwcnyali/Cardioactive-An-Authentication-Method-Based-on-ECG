...
def load_test_data(testname):
 r_peaks = read_peaks(f'peakposition/{testname}/peak_r_{testname}.txt')
 p_peaks = read_peaks(f'peakposition/{testname}/peak_p_{testname}.txt')
 q_peaks = read_peaks(f'peakposition/{testname}/peak_q_{testname}.txt')
 s_peaks = read_peaks(f'peakposition/{testname}/peak_s_{testname}.txt')
 t_peaks = read_peaks(f'peakposition/{testname}/peak_t_{testname}.txt')
...
def main(username, testname):
 ...
 # 加载测试数据
 test_df = load_test_data(testname)
